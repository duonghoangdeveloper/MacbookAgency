 ...
 * @author Duong
 */
public class DeleteMacbookModelServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (admin != null) {
                ...
                boolean success = dao.deleteMacbookModel(txtModelID);
                
                if (success) {
                    url = SUCCESS;
                } else {
                    request.setAttribute("ERROR_MESSAGE", "Delete macbook model failed");
                }
            } else {
                request.setAttribute("ERROR_MESSAGE", "Unauthorized");
            }
        } catch (ClassNotFoundException ex) {
            Logger.getLogger(DeleteMacbookModelServlet.class.getName()).log(Level.SEVERE, null, ex);

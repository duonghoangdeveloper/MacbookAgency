 ...
 * @author Duong
 */
public class DeleteAccessoryCategoryServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (admin != null) {
                ...
                boolean success = dao.deleteAccessoryCategory(txtCategory);
                
                if (success) {
                    url = SUCCESS;
                } else {
                    request.setAttribute("ERROR_MESSAGE", "Delete accessory category failed");
                }
            } else {
                request.setAttribute("ERROR_MESSAGE", "Unauthorized");
            }
        } catch (ClassNotFoundException ex) {
            Logger.getLogger(DeleteAccessoryCategoryServlet.class.getName()).log(Level.SEVERE, null, ex);

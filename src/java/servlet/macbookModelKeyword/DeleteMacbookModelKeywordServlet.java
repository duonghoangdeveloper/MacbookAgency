 ...
 * @author Duong
 */
public class DeleteMacbookModelKeywordServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (admin != null) {
                ...
                boolean success = dao.deleteMacbookModelKeyword(txtModelID, txtKeyword);
                
                if (success) {
                    url = SUCCESS;
                } else {
                    request.setAttribute("ERROR_MESSAGE", "Delete macbook model keyword failed");
                }
            } else {
                request.setAttribute("ERROR_MESSAGE", "Unauthorized");
            }
        } catch (ClassNotFoundException ex) {
            Logger.getLogger(DeleteMacbookModelKeywordServlet.class.getName()).log(Level.SEVERE, null, ex);

    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (admin != null) {
                ...
                if (!admin.getUsername().equals(txtUsername)) {
                    AdminDAO dao = new AdminDAO();
                    boolean success = dao.deleteAdmin(txtUsername);
                    if (success) {
                        url = SUCCESS;
                    } else {
                        request.setAttribute("ERROR_MESSAGE", "Delete admin failed");
                    }
                } else {
                    request.setAttribute("ERROR_MESSAGE", "Can not delete yourself");
                    url = ERROR;
                }
            } else {

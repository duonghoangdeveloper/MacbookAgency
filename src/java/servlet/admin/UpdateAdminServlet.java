...
public class UpdateAdminServlet extends HttpServlet {
    ...
    private final String INVALID = "updateAdmin.jsp";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (admin != null) {
                ...
                AdminErrorDTO error = AdminValidator.validateUpdateAdmin(txtUsername, txtPassword, txtConfirmPassword, txtFullname, txtEmail, txtPhone);

                if (error == null) {
                    AdminDAO dao = new AdminDAO();
                    boolean success = dao.updateAdmin(txtUsername, txtPassword, txtFullname, txtEmail, txtPhone);
                    if (success) {
                        url = SUCCESS;
                    } else {
                        request.setAttribute("ERROR_MESSAGE", "Update admin failed");
                    }
                } else {

    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (admin != null) {
                ...
                boolean success = dao.deleteDomain(txtDomain);
                
                if (success) {
                    url = SUCCESS;
                } else {
                    request.setAttribute("ERROR_MESSAGE", "Delete domain failed");
                }
            } else {
                request.setAttribute("ERROR_MESSAGE", "Unauthorized");
            }
        } catch (ClassNotFoundException ex) {
            Logger.getLogger(DeleteDomainServlet.class.getName()).log(Level.SEVERE, null, ex);

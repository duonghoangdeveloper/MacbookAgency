...
public class CreateDomainServlet extends HttpServlet {
    ...
    private final String INVALID = "createDomain.jsp";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (admin != null) {
                ...
                DomainErrorDTO error = DomainValidator.validateCreateDomain(txtDomain, txtName, txtXslPath);
            ...
            Logger.getLogger(CreateDomainServlet.class.getName()).log(Level.SEVERE, null, ex);

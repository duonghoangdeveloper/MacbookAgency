    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (admin != null) {
                ...
                boolean success = dao.deletePage(txtDomain, txtPath);
                
                if (success) {
                    url = SUCCESS;
                } else {
                    request.setAttribute("ERROR_MESSAGE", "Delete page failed");
                }
            } else {
                request.setAttribute("ERROR_MESSAGE", "Unauthorized");
            }
        } catch (ClassNotFoundException ex) {
            Logger.getLogger(DeletePageServlet.class.getName()).log(Level.SEVERE, null, ex);
